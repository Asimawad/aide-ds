...
class SelfDebugAgent(Agent2): # Inherit from Agent
    def __init__(
        self,
        task_desc: str,
        cfg: Config,
...
#############################################################################
class CodeChainAgent(Agent2): # Inherit from Agent
    def __init__(
        self,
        task_desc: str,
        cfg: Config,
...
class SelfConsistencyAgent(Agent2):
    def __init__(
        self,
        task_desc: str,
        cfg: Config,
