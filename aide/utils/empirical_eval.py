    ...
    #         # --- Retrieve Metrics from run.summary ---
        ...
        results = {
            ...
            "average_metrics": {
                ...
                "Steps to First Working Code inf replaced": round(avg_steps_to_wo, 2) if not np.isnan(avg_steps_to_wo) else None,
                "Steps to First Working Code (only for runs that found it)": round(avg_steps_to_wo_found_only, 2) if not np.isnan(avg_steps_to_wo_found_only) else None,
